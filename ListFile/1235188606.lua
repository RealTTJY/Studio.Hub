...
return {
    ...
    Function = function(CorePackage, WindLib, IntroLib, Windy, ClientPackage, CoruTask, CommonF, ESPF)
        ...
        Functions.SolsticeInit = function(self)
            ...
            local o;o=LowerC(WhackClass.new, IB_NO_VIRTUALIZE(function(...)
            ...
            local EB_new, o;o=LowerC(EventBoss.new, IB_NO_VIRTUALIZE(function(...)
            ...
            local LB_new, o;o=LowerC(LunarBoss.new, IB_NO_VIRTUALIZE(function(...)
                local Returned = o(...); tk.delay(10, function()
            ...
            local OneRunCallMain, OneRunErrorMain = pcall(function()
                ...
                if not CoruTask.Intialized then
                    ...
                    if FishingClient then
                        local o;o=LowerC(FishingClient.StartFishing, IB_NO_VIRTUALIZE(function(self, p2, p3)
                        ...
                        local o;o=LowerC(FishingClient.Click, IB_NO_VIRTUALIZE(function(self, ...)
                    ...
                    local o1;o1=LowerC(require(R.Gamebeast.Infra.Shared.Modules.MetricCollector).ReportMetric, IB_NO_VIRTUALIZE(function(self, metric, value)
                    ...
                    local o2;o2=LowerC(require(RepFolder.MobProjectile).Tick, IB_NO_VIRTUALIZE(function(p1,p2)
                        if DragonCon.Godmode then
                            p1:Destroy();
                        end; return o2(p1,p2);
